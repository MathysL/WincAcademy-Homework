...
const animalSpotted = event => {
    console.log("spotted:", event.target.getElementById);
    const spottedAnimal = event.target.id;
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    animalButtons.forEach(function (animalButton) {animalButton.addEventListener("click", animalSpotted);
    });
